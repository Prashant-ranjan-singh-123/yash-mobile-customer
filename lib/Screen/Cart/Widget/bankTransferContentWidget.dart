        ...
        Padding(
            ...
            child: RichText(
              text: TextSpan(
                ...
                children: <TextSpan>[
                  TextSpan(text: '${getTranslated(context, 'ACCNAME')} : ',style: const TextStyle(fontWeight: FontWeight.bold)),
                  TextSpan(
        ...
        Padding(
            ...
            child: RichText(
              text: TextSpan(
                ...
                children: <TextSpan>[
                  TextSpan(text: '${getTranslated(context, 'ACCNO')} : ',style: const TextStyle(fontWeight: FontWeight.bold)),
                  TextSpan(
        ...
        Padding(
            ...
            child: RichText(
              text: TextSpan(
                ...
                children: <TextSpan>[
                  TextSpan(text: '${getTranslated(context, 'BANKNAME')} : ',style: const TextStyle(fontWeight: FontWeight.bold)),
                  TextSpan(
        ...
        Padding(
            ...
            child: RichText(
              text: TextSpan(
                ...
                children: <TextSpan>[
                  TextSpan(text: '${getTranslated(context, 'BANKCODE')} : ',style: const TextStyle(fontWeight: FontWeight.bold)),
                  TextSpan(
